...
public class DetalleFactura {
	@Id
	@GeneratedValue(generator = "seq_datalle_factura",strategy = GenerationType.SEQUENCE)
	@SequenceGenerator(name = "seq_datalle_factura",sequenceName = "seq_datalle_factura", allocationSize = 1)
	@Column(name="defa_id")
	private Integer id;
